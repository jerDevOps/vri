            ...
            <div className="bg-white rounded-3xl shadow-lg border border-gray-100 p-8 hover:shadow-2xl transition-all group relative overflow-hidden flex flex-col h-full">
                ...
                <div className="mt-auto pt-6 border-t border-gray-100">
                    ...
                    <ul className="space-y-2">
                        {data.observaciones.map((obs, idx) => (
    ...
    return (
        <div className="bg-[#FFFEDB]/30 min-h-screen">
            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden pt-20">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    ...
                    <p className="text-xl md:text-2xl text-white/90 font-medium italic animate-fade-in">
                        "Liderando la vanguardia científica institucional"
                    </p>
                </div>
            </section>

            {/* Quiénes Somos Section with Background */}
            <section className="relative py-28 overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        <SectionTitle
                            title={INSTITUTOS_DATA.about.title}
                            subtitle="Quiénes Somos"
                        />
                        <p className="text-xl text-gray-700 leading-relaxed font-medium">
                            {INSTITUTOS_DATA.about.desc}
                        </p>
                    </div>
                </div>
            </section>
            ...
            <div className="space-y-0">
                {activeYear === '2025' ? (
                    <>
                        {/* 2025 Financiados Section with Background */}
                        <section className="relative py-24 overflow-hidden">
                            ...
                            <div className="container mx-auto px-4 relative z-10">
                                <SectionTitle
                                    title="Institutos con Financiamiento 2025"
                                    subtitle="Proyectos Ganadores"
                                />
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                    {INSTITUTOS_DATA.financiados2025.map((item) => (
                        ...
                        {/* 2025 Reconocidos Section with Background */}
                        <section className="relative py-24 overflow-hidden">
                            <div className="absolute inset-0 z-0">
                                <img
                            ...
                            <div className="container mx-auto px-4 relative z-10">
                                <SectionTitle
                                    title="Institutos Reconocidos UNA PUNO 2025"
                                    subtitle="Prestigio Institucional"
                                />
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                    {INSTITUTOS_DATA.reconocidos2025.map((item) => (
                    ...
                    <>
                        {/* 2024 Reconocidos Section with Background */}
                        <section className="relative py-24 overflow-hidden">
                            <div className="absolute inset-0 z-0">
                                <img
                                    src="/src/assets/bg_institutos_reconocidos.jpg"
                                    alt="Fondo Reconocidos 2024"
                                    className="w-full h-full object-cover opacity-10"
                                />
                                <div className="absolute inset-0 bg-white/50"></div>
                            </div>
                            <div className="container mx-auto px-4 relative z-10">
                                <SectionTitle
                                    title="Institutos Reconocidos UNA PUNO 2024"
                                    subtitle="Trayectoria Histórica"
                                />
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                    {INSTITUTOS_DATA.reconocidos2024.map((item) => (
                                        <InstitutoCard key={item.id} type="reconocido" data={item} />
                                    ))}
                                </div>
                            </div>
