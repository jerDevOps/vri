export const INSTITUTOS_DATA = {
    ...
    financiados2025: [
        {
            id: 1,
            area: "CULTIVOS ANDINOS",
            instituto: "IPSAA",
            proyecto: "Monitorización mediante visión por computador del manejo poscosecha de tubérculos andinos con recubrimientos comestibles",
            puntaje: "14,05",
            resultado: "Proyecto ganador",
            observaciones: [
                "Proyecto seleccionado como ganador",
                "Alto impacto en innovación agroindustrial"
            ]
        },
        {
            id: 2,
            ...
            instituto: "IICCD",
            proyecto: "Plataforma inteligente BOFEDASH para el monitoreo cuasi-real de la degradación de bofedales del altiplano puneño mediante visión computacional, IA e IoT",
            puntaje: "13,75",
            resultado: "Proyecto ganador",
            observaciones: [
        ...
        },
        {
            ...
            area: "CAMÉLIDOS",
            instituto: "IIPCSA",
            proyecto: "Prevalencia y factores asociados a la infección por Fasciola hepatica en zonas endémicas del altiplano peruano: un enfoque integrado One Health",
            puntaje: "10,95",
            resultado: "Proyecto ganador",
            observaciones: [
                "Enfoque sanitario y productivo",
    ...
    reconocidos2025: [
        ...
        },
        {
            ...
            responsable: "Dr. German Belizario Quispe"
        },
        {
            id: 9,
        ...
        },
        {
            ...
            responsable: "Dr. Alejandro Apaza Tarqui"
        },
        {
            id: 11,
            facultad: "Ciencias Agrarias",
            nombre: "INSTITUTO DE INVESTIGACIÓN EN PROTECCIÓN VEGETAL",
            responsable: "Dr. Jesus Heraclides Arcos Pineda"
        },
        {
            id: 12,
        ...
        },
        {
            ...
            nombre: "INSTITUTO DE INVESTIGACIONES EDUCATIVAS – IIEDU DE LA FACULTAD DE CIENCIAS DE LA EDUCACIÓN",
            responsable: "Dr. Heber Nehemias CHUI BETANCUR"
        },
        {
            id: 14,
            facultad: "INGENIERÍA ECONÓMICA",
            nombre: "INSTTTUTO DE INVESTIGACIONES ECONÓMICAS (IIE)",
        ...
        },
        {
            ...
            responsable: "JULIO PEDRO QUISPE AYMACHOQUE Director IIDTMA"
        },
        {
            id: 16,
            facultad: "CIENCIAS DE LA EDUCACIÓN",
        ...
        {
            id: 18,
            facultad: "FACULTAD DE MEDICINA VETERINARI Y ZOOTECNIA",
            nombre: "INSTITUTO DE INVESTIGACIÓN Y DE PROMOCIÓN DE CAMELIDOS SUDAMERICANOS (IIPC)",
            responsable: "DR. CEFERINO UBERTO OLARTE DAZA"
        },
        {
            id: 19,
            facultad: "FACUTAD DE CIENCIAS SOCIALES",
        ...
        },
        {
            ...
            responsable: "Dr. ERNESTO NAYER TUMI FIGUEROA"
        },
        {
            id: 21,
            facultad: "FAC. INGNIERIA MECANICA ELECTRICA, ELECTRONICA Y SISTEMAS",
        ...
        },
        {
            ...
            responsable: "SAMUEL HUAQUISTO CACERES"
        },
        {
            id: 24,
            facultad: "FACULTAD DE INGENIERÍA ESTADISTICA E INFORMATICA",
            nombre: "INSTITUTO DE INVESTIGACIÓN EN INTELIGENCIA COMPUTACIONAL Y CIENCIA DE DATOS – IICCD",
            responsable: "DR. LOENID ALEMAN GONZALES"
        },
        {
            id: 25,
            facultad: "FACUTAD DE CIENCIAS AGRARIAS",
        ...
        },
        {
            id: 26,
            facultad: "FACUTAD DE CIENCIAS SOCIALES",
            nombre: "INSTITUTO DE INVESTIGACIÓN CIENTÍFICA Y HUMANISTICA (IDICH)",
            responsable: "DR. WILBER CESAR CALSINA PONCE"
        },
        {
            id: 27,
            facultad: "FACUTAD DE INGENIERÍA DE MINAS",
            nombre: "INSTITUTO DE INVESTIGACIÓN EN PEQUEÑA MINERA – ISPEMI –",
            responsable: "DR. JUAN WALTER TUDELA MAMANI"
        },
        {
            id: 28,
            facultad: "FACULTAD ING. MECANICA ELECTRICO, ELECTRONICA Y SISTEMAS",
            nombre: "INSTITUTO DE INVESTIGACIÓN EN TECNOLOGÍAS DE INFORMACIÓN Y COMUNICACIÓN ALTO ANDINO – ITICA",
            responsable: "Dr. PABLO CESAR TAPIA CATACORA"
        },
        {
            id: 39,
            facultad: "FACULTAD DE CIENCIAS AGRARIAS",
            nombre: "INSTITUTO DE BIOSOSTENIBILIDAD",
            responsable: "Dr. JUAN MARCO ARO ARO"
        },
        {
            id: 30,
            facultad: "ESCUELA DE POSGRADO",
            nombre: "INSTITUTO DE INVESTIGACIÓN DEL ALTIPLANO – IIA",
            responsable: "Dr. POLAN FRANBALT FERR0 GONZALES"
        },
        {
            id: 31,
            facultad: "FACULTAD DE INGENIERÍA AGRÍCOLA",
            nombre: "INSTITUTO DE INVESTIGACIÓN EN CIENCIA Y TECNOLOGIA DEL AGUA (IICTA)",
    ...
    reconocidos2024: [
        ...
        },
        {
            id: 2,
            facultad: "Ciencias Agrarias",
            nombre: "INSTITUTO DE INVESTIGACIÓN CLASE I EN PROTECCIÓN VEGETAL (IIPV) adscrito a la ESCUELA PROFESIONAL DE AGRONOMIA DE LA FACULTAD DE CIENCIAS AGRARIAS",
            responsable: "Dra. ROSARIO YSABEL BRAVO PORTUCARRERO"
        },
        {
            id: 3,
            facultad: "Ciencias Sociales",
        ...
        {
            id: 8,
            facultad: "FACULTAD DE INGENIERÍA MECÁNICA ELÉCTRICA, ELECTRONICA Y SISTEMAS",
        ...
        },
        {
            ...
            nombre: "INSTITUTO DE INVESTIGACIÓN EN SMART GRID, ENERGIA Y AUTOMATIZACIÓN (IISGEA)",
            responsable: "Dr. JAMES ROLANDO ARREDONDO"
        },
        {
            id: 14,
            facultad: "Ingeniería Civil y Arquitectura",
        ...
        },
        {
            id: 19,
            facultad: "Ingeniería Mecanica Electrica, Electronica y Sistemas",
            nombre: "INSTITUTO DE INVESTIGACIÓN Y DESARROLLO DEL SISTEMA ELÉCTRICO DE POTENCIA",
        ...
        },
        {
            id: 21,
            facultad: "Ingeniería Mecanica Electrica, Electronica y Sistemas",
            nombre: "INSTITUTO DE INVESTIGACIÓN EN TECNOLOGIAS DE INFORMACIÓN Y COMUNICACIÓN ALTO ANDINO – ITICA",
            responsable: "M.Sc. MAGALI GIANINA GONZALES PACO"
        },
        {
            id: 22,
            facultad: "Ciencias Agrarias",
            nombre: "INSTITUTO DE INVESTIGACIÓN EN BIOSOSTENIBILIDAD",
